...
const StyledWrapper = styled.div<{ $butterflysize: string }>`
  /* Butterfly loader created by WerlynDev in Uiverse.io*/

  .loader {
    --sizeLoader: ${({ $butterflysize }) => $butterflysize};
